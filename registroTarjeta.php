      ...
      <div class="pruebaContenedor">
        ...
        <article class="tarjeta" id="tarjeta">
          ...
          <div class="trasera">
            ...
            <p class="leyenda">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ullamex, atque qui adipisci
              consequuntur impedit delectus harum dolor eaque assumenda iure odio magnam tempore error nisi? Illo
        ...
        <form method="POST" action="registro4.php" id="formulario">
          ...
          <div class="cajas">
            ...
            <div class="input-group">
              <input type="text" name="numeroTarjeta" id="numeroTarjeta" required class="input" maxlength="19"
                minlength="19">
