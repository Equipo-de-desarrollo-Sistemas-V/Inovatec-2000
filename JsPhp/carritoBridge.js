          ...
          <div class="containerDatos">
            <div class="datos">
              ...
              <div class="organizador">
                ...
                <input type="number" name="cajaCantidad" id="cajaCantidad${arreglosVariables[4][i]}" min="1" max="99" value="${arreglosVariables[3][i]}" onclick="alterarCantidad(${arreglosVariables[4][i]}); read">
              </div>
